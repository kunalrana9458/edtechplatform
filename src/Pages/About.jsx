...
import StatsComponent from '../componenets/core/AboutPage/StatsComponent'
import LearningGrid from '../componenets/core/AboutPage/LearningGrid'
import ContactFromSection from '../componenets/core/AboutPage/ContactFromSection'

const About = () => {
  return (
    <div className='mx-auto mt-[100px] w-[90%] text-white'>
      {/* section 1 */}
      <section>
        <div>
            <header>
